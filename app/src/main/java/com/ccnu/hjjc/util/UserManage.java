...
public class UserManage {
     ...
     * 保存自动登录的用户信息
     */
    public void saveUserInfo(Context context, String username, String password,int monitor) {
    ...
    public boolean hasUserInfo(Context context) {
        ...
        if (userInfo != null) {
            if ((!TextUtils.isEmpty(userInfo.getUserName())) && (!TextUtils.isEmpty(userInfo.getPassword())) && userInfo.getMonitor()!=-1) {//有数据
                return true;
            } else {
                return false;
            }
